...
const enrollStudent = async (req, res) => {
    const { student_name, fathers_name, mothers_name, contact_no, email_id, fees, date_of_admission } = req.body;
...
const createFeeEntry = async (req, res) => {
    const { student_enrollment_id, fees, amt_paid, late_fine, disc_amt, payment_details, payment_type, cheque_number } = req.body;
...
const incExpEntry = async (req, res) => {
    const { inExp_type, inExp_details, rec_send_name, amt_paid, payment_type, cheque_number, cheque_date } = req.body;
